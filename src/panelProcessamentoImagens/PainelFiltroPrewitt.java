...
public class PainelFiltroPrewitt extends JPanel {
	...
	public PainelFiltroPrewitt(){
		...
		JLabel labelFiltroMedia = new JLabel("Filtro Prewitt");
		...
		JButton botaoMedia = new JButton("Filtro Prewitt");
		botaoMedia.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent eventoDeMouse){	
				panelDaImagem2.InserirImagemNoPainelPrewitt(panelDaImagem1.altura, panelDaImagem1.largura
