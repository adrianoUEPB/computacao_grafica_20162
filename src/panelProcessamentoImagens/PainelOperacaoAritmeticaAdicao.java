...
public class PainelOperacaoAritmeticaAdicao extends JPanel {
	...
	public PainelOperacaoAritmeticaAdicao(){
		...
		panelSuperior.setBounds(0, 0, 924, 48);
		add(panelSuperior);
		panelSuperior.setLayout(null);


		JLabel labelFiltroMedia = new JLabel("Opera\u00E7\u00E3o Aritmetica Adi\u00E7\u00E3o");
		...
		JButton botaoMedia = new JButton("Adicão");
		botaoMedia.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent eventoDeMouse){	
				panelDaImagem3.inserirImagemNoPainelOperacaoAritmeticaAdicao(panelDaImagem1.altura, 
		...
		botaoMedia.setBounds(578, 340, 245, 35);
		add(botaoMedia);
