...
public class PainelOperacaoAritmeticaDivisao extends JPanel {
	...
	public PainelOperacaoAritmeticaDivisao(){
		...
		JLabel labelFiltroMedia = new JLabel("Opera\u00E7\u00E3o Aritmetica Divis\u00E3o");
		...
		bntSelecionarImagem1.setFont(new Font("Segoe UI Semilight", Font.BOLD, 18));
		...
		JButton botaoMedia = new JButton("Divis�oo");
