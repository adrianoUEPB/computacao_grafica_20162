...
public class PainelOperadorLogicoOR extends JPanel {
	...
	public PainelOperadorLogicoOR(){
		...
		JLabel labelFiltroMedia = new JLabel("Operação Lógica OR");
		...
		JButton bntXOR = new JButton("OR");
		bntXOR.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent eventoDeMouse){	
				panelDaImagem3.inserirImagemNoPainelOperadorLogicoOR(panelDaImagem1.altura,	panelDaImagem1.largura,	
