...
public class PainelFiltroRobertsCruzado extends JPanel {
	...
	public PainelFiltroRobertsCruzado(){
		...
		JLabel labelFiltroMedia = new JLabel("Filtros Roberts Cruzado");
		...
		JButton botaoMedia = new JButton("Filtro Roberts Cruzado");
		botaoMedia.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent eventoDeMouse){	
				panelDaImagem2.InserirImagemNoPainelRobertsCruzado(panelDaImagem1.altura, panelDaImagem1.largura
