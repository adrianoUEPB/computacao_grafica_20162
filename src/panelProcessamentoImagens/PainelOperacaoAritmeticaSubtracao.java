...
public class PainelOperacaoAritmeticaSubtracao extends JPanel {
	...
	public PainelOperacaoAritmeticaSubtracao(){
		...
		JLabel labelFiltroMedia = new JLabel("Opera\u00E7\u00E3o Aritmetica Subtrac\u00E3o");
		...
		JButton botaoMedia = new JButton("Subtracão");
		botaoMedia.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent eventoDeMouse){	
				panelDaImagem3.inserirImagemNoPainelOperacaoAritmeticaSubtracao(panelDaImagem1.altura, 
